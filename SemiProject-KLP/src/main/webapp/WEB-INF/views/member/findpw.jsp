...
<div class="check_email">
	  ...
	  <p class="title">비밀번호 찾기를 위한 회원 인증을 진행합니다.<!-- <br>가입시 사용한 메일 주소를 입력해주세요. --></p>
	  <div class="flex_row mt-2">
		    <div class="mb-1">아이디</div> <input required class="form-control w-25 me-3" name="id" id="input_id" placeholder="아이디" value="">
	  </div>
	  <div class="flex_row mt-2">
...
<script>
	...
	$("#sendBtn").click(e=>{
		if($("input#input_email").val().trim() ===""){
			...
			alert('생일을 입력해주세요.');
		}else if($("input#input_id").val().trim() ===""){
			alert('아이디를 입력해주세요.');
		}else{
			$.ajax({
