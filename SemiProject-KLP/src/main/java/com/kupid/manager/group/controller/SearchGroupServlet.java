 ...
 */
@WebServlet("/manager/searchgroup.do")
public class SearchGroupServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<GroupDto> searchGroup=new GroupService().searchGroup(keyword,cPage,numPerpage);
		
		request.setAttribute("group", searchGroup);
		
		int totalData=new GroupService().searchGroupCount(keyword);
