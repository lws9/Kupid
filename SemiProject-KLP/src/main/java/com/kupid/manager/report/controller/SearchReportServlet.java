 ...
 */
@WebServlet("/manager/searchreport.do")
public class SearchReportServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Report> searchReport=new ReportService().searchReport(type,keyword,cPage,numPerpage);
		
		request.setAttribute("report", searchReport);
		
		int totalData=new ReportService().searchReportCount(type, keyword);
