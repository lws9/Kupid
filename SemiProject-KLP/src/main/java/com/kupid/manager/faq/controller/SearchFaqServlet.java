 ...
 */
@WebServlet("/manager/searchFaq.do")
public class SearchFaqServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Faq> searchFaq=new FaqService().searchFaq(type,keyword,cPage,numPerpage);
		
		request.setAttribute("faq", searchFaq);
		
		int totalData=new FaqService().searchFaqCount(type, keyword);
